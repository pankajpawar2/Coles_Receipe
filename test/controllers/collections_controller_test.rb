...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { category_name: @collection.category_name, image_url: @collection.image_url } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { category_name: @collection.category_name, image_url: @collection.image_url } }
